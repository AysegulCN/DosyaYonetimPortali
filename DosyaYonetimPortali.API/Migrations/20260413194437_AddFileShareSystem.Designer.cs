...
namespace DosyaYonetimPortali.API.Migrations
{
    ...
    [Migration("20260413194437_AddFileShareSystem")]
    partial class AddFileShareSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DosyaYonetimPortali.API.Models.AppFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DosyaYonetimPortali.API.Models.AppUser", b =>
                {
                    ...
                    b.Property<long>("TotalStorageQuota")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DosyaYonetimPortali.API.Models.FileShare", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DosyaYonetimPortali.API.Models.FileShare", b =>
                {
                    b.HasOne("DosyaYonetimPortali.API.Models.AppFile", "File")
                        .WithMany("SharedWithUsers")
                        .HasForeignKey("FileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DosyaYonetimPortali.API.Models.AppUser", "SharedWithUser")
                        .WithMany()
            ...
            modelBuilder.Entity("DosyaYonetimPortali.API.Models.Folder", b =>
                {
                    ...
                    b.HasOne("DosyaYonetimPortali.API.Models.Folder", "ParentFolder")
                        .WithMany("SubFolders")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DosyaYonetimPortali.API.Models.AppUser", null)
                        .WithMany()
